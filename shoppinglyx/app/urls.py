...
urlpatterns = [
    ...
    path('passwordchang/',auth_views.PasswordChangeView.as_view
         (template_name='app/passwordchang.html',form_class=
          MyPasswordChangeForm , success_url='/passwordchangedone/'
          ),name='passwordchang'),
    ...
    path('password-reset-confirm/<uidb64>/<token>/',auth_views.
     PasswordResetConfirmView.as_view(template_name='app/password_reset_confirm.html',form_class
          = MySetPasswordForm),name='password_reset_confirm'),
